...
function createEdgeWorkerIdDir(ewId: string) {
	...
	// Add try/catch logic incase user doesn't have permissions to write directories needed
	try {
...
export function determineTarballDownloadDir(
	...
	// Regardless of what was picked, make sure it exists - if it doesn't, attempt to create it
	// Add try/catch logic incase user doesn't have permissions to write directories needed
	try {
